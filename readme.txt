...
geschieht via AJAX, damit die Ausgabe der Webseite nicht durch den zusätzlichen Request verzögert wird.
...
4) Das Widget kannst du dann sofort unter Design->Widgets in dein Theme einbinden. Für Seiten und Artikel gibt es dann den Shortcode.

Unter den EInstellungen kannst du die Standartwerte vorgeben und die Shortcodes nachschlagen.

== Frequently Asked Questions ==

= Wie nutze ich ein eigenes Template für eigenes HTML/CSS? =
Kein Problem, das geht ganz einfach. Diese Anleitung gilt für die Inline-Anzeige und das Widget - nimm einfach die jeweils wie gewünscht benannten Dateien.
...
2) Benenne diese dann dort um, so wie du dein Template nennen möchtest. Z.B. "scoutnet-kalender_inline_kalender_MEINNAME_list.php"
